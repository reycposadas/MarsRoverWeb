...
! function (e) {
    ...
    t = {
        ...
        _initTemplateDefaults: function () {
            var i, a, r, n, o, l, s, d, c, p, u, f, m, v, g, h, w, _, b, C, y, x, T, E, S, k, F, P, I, A, z, D, $, j, U, B, O, R, L, M = this;
        ...
        readFiles: function (i) {
            ...
            r.loadedImages = [], r.totalImagesCount = 0, e.each(i, function (e, t) {
                ...
                var T, E, S, k, F, P, I, A, z, D, $, j, U = v + x,
                    B = u + "-" + U,
                    O = i[x],
                    R = m.text,
                    L = m.image,
                ...
                if (h > 0)
                    for (E = 0; h > E; E++) P = g[E], I = r.msgFileTypes[P] || P, q += 0 === E ? I : ", " + I;
